...
<?php
    if(isset($_POST['nom']) && !empty($_POST['nom']) && isset($_POST['email']) &&!empty($_POST['email']) && isset($_POST['phone']) && !empty($_POST['phone']) && isset($_FILES['image']) && !empty($_FILES['image'])){
        if(valid_name($_POST['nom'])) $nom = $_POST['nom'];
        if(valid_email($_POST['email'])) $email = $_POST['email'];
        if(valid_phone($_POST['phone'])) $phone = $_POST['phone'];
